...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_TOO_LONG_STRING = 1162; //SQLSTATE: 42000 Message: se.kerem.moo.blueprint.Result string is longer than 'max_allowed_packet' bytes
    ...
    public final static int ER_TOO_MANY_ROWS = 1172; //SQLSTATE: 42000 Message: se.kerem.moo.blueprint.Result consisted of more than one row
    ...
    public final static int ER_WARN_ALLOWED_PACKET_OVERFLOWED = 1301; //SQLSTATE: HY000 Message: se.kerem.moo.blueprint.Result of %s() was larger than max_allowed_packet (%ld) - truncated
    ...
    public final static int ER_IO_READ_ERROR = 1810; //SQLSTATE: HY000 Message: se.kerem.moo.io.IO Read error: (%lu, %s) %s
    public final static int ER_IO_WRITE_ERROR = 1811; //SQLSTATE: HY000 Message: se.kerem.moo.io.IO Write error: (%lu, %s) %s
    ...
    public final static int ER_STOP_REPLICA_IO_THREAD_TIMEOUT = 1876; //SQLSTATE: HY000 Message: STOP REPLICA command execution is incomplete: Replica se.kerem.moo.io.IO thread got the stop signal, thread is busy, se.kerem.moo.io.IO thread will stop once the current task is complete.; was introduced in 5.7.2.
