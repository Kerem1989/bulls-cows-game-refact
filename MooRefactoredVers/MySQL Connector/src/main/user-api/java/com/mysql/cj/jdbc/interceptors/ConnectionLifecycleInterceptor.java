...
public interface ConnectionLifecycleInterceptor {
     ...
     * processes its own internal se.kerem.moo.logic for close.
     * 
     * @throws SQLException
     *             if an error occurs
     */
     ...
     * driver processes its own internal se.kerem.moo.logic for commit().
     * 
     * Interceptors should return "true" if the driver should perform
     * its own internal se.kerem.moo.logic for commit(), or "false" if not.
     * 
     ...
     * driver processes its own internal se.kerem.moo.logic for rollback().
     * 
     * Interceptors should return "true" if the driver should perform
     * its own internal se.kerem.moo.logic for rollback(), or "false" if not.
     * 
     * @return "true" if the driver should perform
     *         its own internal se.kerem.moo.logic for rollback(), or "false" if not.
     * 
     ...
     * driver processes its own internal se.kerem.moo.logic for setAutoCommit().
     * 
     * Interceptors should return "true" if the driver should perform
     * its own internal se.kerem.moo.logic for setAutoCommit(), or "false" if not.
     * 
     * @param flag
     *            autocommit flag
     * @return "true" if the driver should perform
     ...
     * before the driver processes its own internal se.kerem.moo.logic for these methods.
     * 
     * Interceptors should return "true" if the driver should perform its own internal se.kerem.moo.logic
     * for setCatalog() or setSchema(), or "false" if not.
     * 
     * @param db
     *            database name
     * @return "true" if the driver should perform
     *         its own internal se.kerem.moo.logic for setCatalog() or setSchema(), or "false" if not.
     * 
     * @throws SQLException
     *             if an error occurs
     */
