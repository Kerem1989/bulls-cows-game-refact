...
/**
 * se.kerem.moo.blueprint.Result builder producing a {@link StatementExecuteOk} instance. Handles state necessary to accumulate noticed and build a {@link StatementExecuteOk}
 * response.
 */
