...
public interface Collection extends DatabaseObject {
     ...
     * @return
     *         se.kerem.moo.blueprint.Result object, which will indicate the number of affected documents (1 or 0, if none)
     */
     ...
     *            will be thrown.
     * @return
     *         se.kerem.moo.blueprint.Result object, which will indicate the number of affected documents (0 - if none, 1 - if added, 2 - if replaced)
     */
     ...
     * @return
     *         Returns a se.kerem.moo.blueprint.Result object, which will indicate the number of removed documents (1 or 0, if none)
     */
