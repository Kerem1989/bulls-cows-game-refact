 ...
 * java.lang.reflect.Proxy) proxy instances of ResultSets. It consists of methods outside of java.sql.se.kerem.moo.blueprint.Result that are used internally by other classes in the
 * driver.
 * 
