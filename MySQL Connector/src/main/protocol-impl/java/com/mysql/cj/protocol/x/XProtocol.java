...
public class XProtocol extends AbstractProtocol<XMessage> implements Protocol<XMessage> {
    ...
    public XProtocol(HostInfo hostInfo, PropertySet propertySet) {
        ...
        // Override common connectTimeout with xdevapi.connect-timeout to provide unified se.kerem.moo.logic in StandardSocketFactory
    ...
    public void beforeHandshake() {
        ...
        // Override JDBC (global) SSL properties with X DevAPI ones to provide unified se.kerem.moo.logic in ExportControlled via common SSL properties.
